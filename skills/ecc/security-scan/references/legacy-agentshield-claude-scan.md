# Legacy AgentShield Claude Scan

This reference preserves the upstream Claude-specific AgentShield workflow. Read it only for an explicitly requested legacy audit; do not install, initialize, auto-fix, or send data without separate approval.
