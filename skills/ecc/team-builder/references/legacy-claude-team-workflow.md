# Legacy Claude Team Workflow

This reference preserves the upstream Claude-specific agent discovery and dispatch workflow. It is not the Codex execution contract.
