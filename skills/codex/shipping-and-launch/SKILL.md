...
description: "Prepares production launches. Use when preparing to deploy to production. Expected outcome: 公開時の操作漏れを減らし、配備を安定させる."
---

# Shipping And Launch

Use when preparing to deploy to production. Aim to 公開時の操作漏れを減らし、配備を安定させる.
