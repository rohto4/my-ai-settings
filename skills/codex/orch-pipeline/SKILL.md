---
name: orch-pipeline
description: "Shared orchestration engine for the orch-* skill family. Use for Orch Pipeline work that requires the source-specific procedures in the bundled domain guide. Expected outcome: 成果物の品質と一貫性を高める."
---

# Orch Pipeline

Use for Orch Pipeline work that requires the source-specific procedures in the bundled domain guide. Aim to 成果物の品質と一貫性を高める.
