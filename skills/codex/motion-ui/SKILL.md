---
name: motion-ui
description: "Production-ready UI motion system for React/Next.js. Use when implementing animations, transitions, or motion patterns. Expected outcome: 該当技術の実装精度と検証効率を高める."
---

# Motion UI

Use when implementing animations, transitions, or motion patterns. Aim to 該当技術の実装精度と検証効率を高める.
...
- Windows/PowerShell同等手順とLiteralPath・drive-letter・同一shell内の安全確認 / 577行の本文を入口、判断表、referencesへ分割し、最初に読む文脈量を抑える / 長期作業はAGENTS.md/PROJECT.mdとdocs/impを実体再読し、進行中と完了証拠を分離
