...
description: "Prisma ORM patterns for TypeScript backends — schema design, query optimization, transactions, pagination, and critical traps like updateMany returning count not records, $transaction timeouts, migrate dev resetting the DB, @updatedAt. Use for Prisma Patterns work that requires the source-specific procedures in the bundled domain guide. Expected outcome: 該当技術の実装精度と検証効率を高める."
---

# Prisma Patterns

Use for Prisma Patterns work that requires the source-specific procedures in the bundled domain guide. Aim to 該当技術の実装精度と検証効率を高める.
