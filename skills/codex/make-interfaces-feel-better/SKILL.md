...
description: "Apply concrete design-engineering details that make interfaces feel polished. Use when reviewing or improving UI spacing, typography, borders, shadows, motion, hit areas, icons, text wrapping, and interaction states. Expected outcome: 成果物の品質と一貫性を高める."
---

# Make Interfaces Feel Better

Use when reviewing or improving UI spacing, typography, borders, shadows, motion, hit areas, icons, text wrapping, and interaction states. Aim to 成果物の品質と一貫性を高める.
