...
description: "End-to-end methodology for AI agents and software engineers to add machine learning algorithms to existing non-ML codebases. Use for ML Adoption Playbook work that requires the source-specific procedures in the bundled domain guide. Expected outcome: 手順の抜け漏れを減らし、作業を再現しやすくする."
---

# ML Adoption Playbook

Use for ML Adoption Playbook work that requires the source-specific procedures in the bundled domain guide. Aim to 手順の抜け漏れを減らし、作業を再現しやすくする.
