# Upstream domain guide: Dynamic Workflow Mode
...
- The user mentions dynamic workflows, custom harnesses, harness-per-task, adaptive workflows, or Codex or the active coding agent dynamic workflow mode.
