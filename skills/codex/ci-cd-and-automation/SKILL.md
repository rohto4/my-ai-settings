...
description: "Automates CI/CD pipeline setup. Use when setting up or modifying build and deployment pipelines. Expected outcome: 定型作業と判断のばらつきを減らし、運用を安定させる."
---

# CI CD And Automation

Use when setting up or modifying build and deployment pipelines. Aim to 定型作業と判断のばらつきを減らし、運用を安定させる.
