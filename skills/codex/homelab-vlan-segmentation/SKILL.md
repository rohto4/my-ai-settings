...
description: "Segmenting home networks into VLANs for IoT, guest, trusted, and server traffic using UniFi, pfSense/OPNsense, and MikroTik — including switch trunk config, firewall rules, and wireless SSID mapping. Use for Homelab Vlan Segmentation work that requires the source-specific procedures in the bundled domain guide. Expected outcome: 専門判断の精度を高め、調査の手戻りを減らす."
---

# Homelab Vlan Segmentation

Use for Homelab Vlan Segmentation work that requires the source-specific procedures in the bundled domain guide. Aim to 専門判断の精度を高め、調査の手戻りを減らす.
