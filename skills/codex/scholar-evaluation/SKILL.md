...
description: "Structured scholarly-work evaluation for papers, proposals, literature reviews, methods sections, evidence quality, citation support, and research-writing feedback. Use for Scholar Evaluation work that requires the source-specific procedures in the bundled domain guide. Expected outcome: 成果物の品質と一貫性を高める."
---

# Scholar Evaluation

Use for Scholar Evaluation work that requires the source-specific procedures in the bundled domain guide. Aim to 成果物の品質と一貫性を高める.
...
- frontmatter name「scholar-evaluation」とfolder「scientific-thinking-scholar-evaluation」の不一致を解消し、Codex discovery時の識別を一意にする
