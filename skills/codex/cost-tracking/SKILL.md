---
name: cost-tracking
description: "Track and report Claude Code token usage, spending, and budgets from the local ECC cost-tracker metrics log. Use when the user asks about costs, spending, usage, tokens, budgets, or cost breakdowns by model, session, or date. Expected outcome: 成果物の品質と一貫性を高める."
---

# Cost Tracking

Use when the user asks about costs, spending, usage, tokens, budgets, or cost breakdowns by model, session, or date. Aim to 成果物の品質と一貫性を高める.
