...
description: "Manages deprecation and migration. Use when removing old systems, APIs, or features. Expected outcome: 互換性リスクと移行時の手戻りを減らす."
---

# Deprecation And Migration

Use when removing old systems, APIs, or features. Aim to 互換性リスクと移行時の手戻りを減らす.
