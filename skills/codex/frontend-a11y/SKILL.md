---
name: frontend-a11y
description: "Accessibility patterns for React and Next.js — semantic HTML, ARIA attributes, form labeling, keyboard navigation, focus management, and screen reader support. Use when building any interactive UI component or form. Expected outcome: 該当技術の実装精度と検証効率を高める."
---

# Frontend A11y

Use when building any interactive UI component or form. Aim to 該当技術の実装精度と検証効率を高める.
