# Upstream domain guide: Team Agent Orchestration
...
- The user mentions team orchestration, agent Kanban, squad, conductor, control pane, manager, desktop app, Zellij, tmux, Hermes, Devin, Codex, Codex or the active coding agent, or multi-agent work.
