# Upstream domain guide: Social Publisher
...
Connects Codex or the active coding agent to [SocialClaw](https://getsocialclaw.com) for agent-driven social media publishing across 13 platforms through a single workspace API key.
