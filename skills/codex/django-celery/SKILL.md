---
name: django-celery
description: "Django + Celery async task patterns — configuration, task design, beat scheduling, retries, canvas workflows, monitoring, and testing. Use when adding background jobs, scheduled tasks, or async processing to a Django app. Expected outcome: 該当技術の実装精度と検証効率を高める."
---

# Django Celery

Use when adding background jobs, scheduled tasks, or async processing to a Django app. Aim to 該当技術の実装精度と検証効率を高める.
