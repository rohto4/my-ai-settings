# Upstream domain guide: React Patterns
...
See [rules/react/hooks.md](upstream-assets/../../rules/react/hooks.md) for the full ruleset. Highlights:
...
- Run `axe` in component tests (see [skills/react-testing](upstream-assets/../react-testing/SKILL.md))
- Cross-link: [skills/accessibility/SKILL.md](upstream-assets/../accessibility/SKILL.md) covers WCAG criteria and pattern libraries
...
- Rules: [rules/react/](upstream-assets/../../rules/react/) — coding-style, hooks, patterns, security, testing
- Skills: [react-performance](upstream-assets/../react-performance/SKILL.md) for the Vercel-derived performance ruleset, [frontend-patterns](upstream-assets/../frontend-patterns/SKILL.md) for cross-framework UI concerns, [accessibility](upstream-assets/../accessibility/SKILL.md), [angular-developer](upstream-assets/../angular-developer/SKILL.md) for framework comparison
