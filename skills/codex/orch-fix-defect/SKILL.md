...
description: "Orchestrate fixing a bug — reproduce it as a failing regression test, fix to green, review, and gated commit — by delegating each phase to the matching ECC agent. Use when existing behavior is broken or wrong. Expected outcome: 成果物の品質と一貫性を高める."
---

# Orch Fix Defect

Use when existing behavior is broken or wrong. Aim to 成果物の品質と一貫性を高める.
