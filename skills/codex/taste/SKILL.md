---
name: taste
description: "A creative-direction (taste) layer for music videos and short-form edits in the angelcore / cloud-trance / hyperpop visual family. Use when the work is not just making a video function but making it feel intentional, when building a music video, a fancam/edit, a moodboard-driven reel, or when choosing a coherent visual direction for AI-generated b-roll. Expected outcome: 成果物の品質と一貫性を高める."
---

# Taste

Use when the work is not just making a video function but making it feel intentional, when building a music video, a fancam/edit, a moodboard-driven reel, or when choosing a coherent visual direction for AI-generated b-roll. Aim to 成果物の品質と一貫性を高める.
...
- Windows/PowerShell同等手順とLiteralPath・drive-letter・同一shell内の安全確認 / 完了条件・check/test・観測結果・未検証範囲を出力契約化
