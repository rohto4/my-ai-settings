...
description: "Creates specs before coding. Use when starting a new project, feature, or significant change and no specification exists yet. Expected outcome: 実装の抜け漏れを減らし、作業効率を高める."
---

# Spec Driven Development

Use when starting a new project, feature, or significant change and no specification exists yet. Aim to 実装の抜け漏れを減らし、作業効率を高める.
