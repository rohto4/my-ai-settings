# Upstream domain guide: Ecc Guide
...
Use this skill when a user needs help understanding, navigating, installing, or choosing parts of Everything Codex or the active coding agent.
...
- `<project-agent-config>/`, `.cursor/`, `.codex/`, `.gemini/`, `.opencode/`, `.codebuddy/`, `.joycode/`, or `.qwen/`
- `hooks/hooks.json`
- install-state files
