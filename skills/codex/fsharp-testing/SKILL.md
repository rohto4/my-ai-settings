---
name: fsharp-testing
description: "F# testing patterns with xUnit, FsUnit, Unquote, FsCheck property-based testing, integration tests, and test organization best practices. Use for Fsharp Testing work that requires the source-specific procedures in the bundled domain guide. Expected outcome: 回帰や見落としを減らし、変更の信頼性を高める."
---

# Fsharp Testing

Use for Fsharp Testing work that requires the source-specific procedures in the bundled domain guide. Aim to 回帰や見落としを減らし、変更の信頼性を高める.
