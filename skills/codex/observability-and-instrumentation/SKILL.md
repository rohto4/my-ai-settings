...
description: "Instruments code so production behavior is visible and diagnosable. Use when adding logging, metrics, tracing, or alerting. Expected outcome: 異常を早期発見し、復旧判断を速める."
---

# Observability And Instrumentation

Use when adding logging, metrics, tracing, or alerting. Aim to 異常を早期発見し、復旧判断を速める.
