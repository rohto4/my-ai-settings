...
description: "Orchestrate building a brand-new feature end to end — research, plan, TDD implementation, review, and gated commit — by delegating each phase to the matching ECC agent. Use when adding a capability that does not exist yet. Expected outcome: 成果物の品質と一貫性を高める."
---

# Orch Add Feature

Use when adding a capability that does not exist yet. Aim to 成果物の品質と一貫性を高める.
