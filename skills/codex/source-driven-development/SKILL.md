...
description: "Grounds every implementation decision in official documentation. Use when you want authoritative, source-cited code free from outdated patterns. Expected outcome: 実装の抜け漏れを減らし、作業効率を高める."
---

# Source Driven Development

Use when you want authoritative, source-cited code free from outdated patterns. Aim to 実装の抜け漏れを減らし、作業効率を高める.
