# Upstream domain guide: React Testing
...
Cross-link: [skills/accessibility/SKILL.md](upstream-assets/../accessibility/SKILL.md) for the broader a11y testing playbook.
...
For any of those, use Playwright Component Testing (component test in real browser) or full E2E. See [e2e-testing skill](upstream-assets/../e2e-testing/SKILL.md).
...
- Rules: [rules/react/testing.md](upstream-assets/../../rules/react/testing.md)
- Skills: [react-patterns](upstream-assets/../react-patterns/SKILL.md), [accessibility](upstream-assets/../accessibility/SKILL.md), [e2e-testing](upstream-assets/../e2e-testing/SKILL.md), [tdd-workflow](upstream-assets/../tdd-workflow/SKILL.md)
