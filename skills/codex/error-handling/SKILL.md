---
name: error-handling
description: "Patterns for robust error handling across TypeScript, Python, and Go. Use for Error Handling work that requires the source-specific procedures in the bundled domain guide. Expected outcome: 原因特定を速め、復旧までの試行錯誤を減らす."
---

# Error Handling

Use for Error Handling work that requires the source-specific procedures in the bundled domain guide. Aim to 原因特定を速め、復旧までの試行錯誤を減らす.
