# Upstream domain guide: Tinystruct Patterns
...
- [Architecture & Config](upstream-assets/references/architecture.md) — Abstractions, Package Map, Properties
- [Routing & @Action](upstream-assets/references/routing.md) — Annotation details, Modes, Parameters
- [Data Handling](upstream-assets/references/data-handling.md) — Builder, Builders, JSON serialization & parsing
- [Database Persistence](upstream-assets/references/database.md) — AbstractData POJOs, CRUD, mapping XML, POJO generation
- [System & Usage](upstream-assets/references/system-usage.md) — Context, Sessions, SSE, File Uploads, Events, Networking
- [Testing Patterns](upstream-assets/references/testing.md) — JUnit 5 unit and HTTP integration testing
