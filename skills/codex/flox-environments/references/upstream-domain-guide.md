# Upstream domain guide: Flox Environments
...
This makes Flox a natural fit for any workflow where Codex or the active coding agent or other AI agents need to bootstrap project tooling on the fly.
...
The following skills are available as part of the [Flox Codex or the active coding agent plugin](https://github.com/flox/flox-agentic) for deeper integration:
